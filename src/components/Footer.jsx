    ...
    <footer className="bg-gradient-to-b from-white to-primary-100 border-t-2 border-primary-200 mt-auto">
      <div className="max-w-7xl mx-auto px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-lg font-bold text-primary-700 mb-4">{t('footer.followMe')}</h3>
            <div className="flex gap-4">
              <a 
                href="https://www.linkedin.com/in/maria-wallberg-067542253" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 bg-primary-500 hover:bg-primary-600 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg"
                aria-label="LinkedIn"
              >
              ...
              <a 
                href="https://www.instagram.com/maria.walli04/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md hover:shadow-lg"
